# Sudoku Puzzle
 ...
 ## Description 
    ...
    When I renamed project.py and moved it to src folder, github asked me to commit and pull- so I did. Although it registered project.py as a new file instead of just being the same original file but renamed and moved, and it erased both the original file and its my commit history for the code - only displaying the pull commit. When I view the code in Github and then click "blank" it only shows the commit pull and when I did it, and it doesn't show the other commits I did and when I did them like the original file did. I am sorry if this causes problems when grading my code.
